  ...
  return (
    <div className="info-container">
      ...
      <h3>
        ...
        <br/><br/>
        At the same time, I have a strong background in media. I’ve done graphic design, photo editing, and content creation for social media, and I’ve worked on larger creative projects like videos and event productions. That experience changed how I approach my work. I pay attention not just to how something works, but how it looks and feels.
        <br/><br/>
